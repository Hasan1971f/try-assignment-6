...
const htmlContentsForCart = (item) => {
    ...
    return `
                    <div class="card bg-base-100 w-full  lg:w-[270px] shadow-xl  p-2 border my-1 cursor-pointer " id="card">
                        <figure class="w-[100%] h-[150px] m-auto ">
                            <img src="${image || "./images/cat.png"}" alt="Loading..." class=" w-full object-cover rounded-[10px] md:w-full" />
                        </figure>
                        <div class="fex justify-start items-start gap-3 my-2 p-2 ">
                            <h2 class="font-bold ">${pet_name || '<span class="text-[gray] font-bold">Not found</span>'}</h2>
                            <p class="flex justify-start items-center gap-2 mb-2 ">
                                <i class="fa-brands fa-windows"></i>
                                <span>Breed: ${breed || '<span class="text-[gray] font-bold">Not found</span>'}</span>
                            </p>
                            <p class="flex justify-start items-center gap-2 mb-2 ">
                                <i class="fa-solid fa-calendar-days"></i>
                                <span>Date of birth: ${date_of_birth || '<span class="text-[gray] font-bold">Not found</span>'}</span>
                            </p>
                            <p class="flex justify-start items-center gap-2 mb-2 ">
                                <i class="fa-solid fa-mercury"></i>
                                <span>Gender: ${gender || '<span class="text-[gray] font-bold">Not found</span>'}</span>
                            </p>
                            <p class="flex justify-start items-center gap-2 mb-2 ">
                                <span>$</span><b>Price</b>: ${item.price || '<span class="text-[gray] font-bold">Not found</span>'}
                            </p>
    ...
    try {
        ...
        details_container.innerHTML = `        
                        <div class=" h-max w-full md:w-[60%]   rounded-[20px] shadow    bg-[white] p-3 flex justify-center items-start gap-5 flex-col" id="modal">
                            <div class="w-[100%] my-2 h-[200px] overflow-y-auto ">
                            <img src="${image || "./images/cat.png"}" alt="Loading..." class="w-full h-[500px] object-cover rounded-[20px]   " >

                            </div>
                            <div class=" flex  justify-start items-center gap-0 lg:gap-1 flex-wrap ">
                            ...
                            <p class="flex justify-start items-center gap-1  w-[40%] ">
                                <span>$</span><b>Price</b>: ${price || '<span class="text-[gray] font-bold"> not found</span>'}
                            </p>
                             <p class="flex justify-start items-center gap-1 ">
                                <span></span><b>vaccinated_status</b>: ${vaccinated_status || '<span class="text-[gray] font-bold">Not found</span>'}
                            </p>
                            </div>
                            <div>
                                <h2 class="font-bold ">Details Information</h2>
                                <p class="text-[gray] ">${pet_details || '<span class="text-[gray] font-bold">not found</span>'}</p>
                            </div>
...
//     const alldatacontainer = document.getElementById("alldaaconteiner")
//     try{
